...
(function (Aufg6_Wiese) {
    ...
    function init(_event) {
        ...
        for (var i = 0; i < menge; i++) {
            ...
            var b = { x: 0, y: 0, g: 0, farbe: "#0000ff" };
            b.x = 1250;
            b.y = 420;
            b.g = Math.random() * 5 + 2;
    ...
    function erzeugeBieneAmBienenkorb() {
        var bienenKorbX = 1250;
        var bienenKorby = 420;
        var bienenG = Math.random() * 5 + 2; // Anmerkung: Variablenname g nicht wirklich aussagekräftig. Größe?
        var bienenFarbe = "hsl(" + Math.random() * 360 + ", 100%, 50%)";
        // Erzeuge neue Biene
        var tempNewBee = { x: bienenKorbX, y: bienenKorby, g: bienenG, farbe: bienenFarbe };
